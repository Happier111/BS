...
<button class="button" @click="this.$router.push('/')">主页</button>
<button class="button" @click="this.$router.push('/shopCar')">购物车</button>
<button class="button" @click="this.$router.push('/userdetail')">个人中心</button>
<button class="button" @click="this.$router.push('/register')">注册</button>
<button class="button" @click="this.$router.push('/dealView')">订单</button>
<a v-if="showButton" @click="handleClick">退出登录</a>
      ...
      <el-footer style="position: fixed; bottom: 0; width: 100%; z-index: 10;">
        <div class="w">
          <div class="links">
...
watch: {
    Islogin(newValue) {
        this.showButton = Boolean(newValue);
    }
},
