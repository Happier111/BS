    ...
    export default {
        data() {
            ...
            return {
                ...
                rules: {
                    username: [
                        { required: true,message: '请输入姓名', validator: checkUsername, trigger: 'blur'}
                    ],
                    password: [
                        { required: true,message: '请输入密码', validator: checkPassword, trigger: 'blur' }
                    ],
                    Password2: [
                        { required: true,message: '请输入确认密码', validator: checkPassword2, trigger: 'blur' }
                    ],
                    email: [
                        { required: true,message: '请输入邮箱', validator: checkEmail, trigger: 'blur' }
                    ],
                    name: [
                        { required: true,message: '请输入真实姓名', validator: checkname, trigger: 'blur' }
                    ],
                    phone: [
                        { required: true,message: '请输入手机号码', validator: checkPhone, trigger: 'blur'}
                    ],
                    account: [
